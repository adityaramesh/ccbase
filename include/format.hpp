...
** set_scientific
** set_fixed
** write	Writes formatted text to a stream.
** writeln	Writes formatted text to a stream, ending with std::endl.
** print	Writes foramtted text to stdout.
** println	Writes formatted text to stdout, ending with std::endl.
*/
